 ...
 * @since 
 */
public enum Cactx102Result12NTxFileDefinition implements IFileDefinition {
	...
	Cactx102Result12NTxFileDefinition(int type, int required, int length, String columnName, String name) {
		this.type = type;
