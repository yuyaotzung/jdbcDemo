 ...
 * @since
 */
public enum Cactx502ResultN2NTxFileDefinition implements IFileDefinition {

	/** 欄位代號(類型 - 1:文字(X) 2:整數(9) 3:小數(9並顯示設定欄), 是否必填 ,長度, 資料庫欄位, 欄位名稱(說明)) */
	BATCH_NO(2, 0, 24, "", "批號PBMT-BATCH-NO"),
	SERNO(2, 0, 5, "", "流水號"),
	PAY_CHANEL(1, 0, 1, "", "付款通路"),
	PAYER_ACCOUNT_NO(2, 0, 14, "", "付款人帳號"),
	PAYER_NAME(1, 0, 76, "", "付款人戶名"),
	...
	CBRCountry1(1, 0, 2, "", "付款人國別"),
	CBRCountry2(1, 0, 2, "", "收款人國別"), //轉帳-收款人國別,匯款-匯款地國別
	CBRREQ2(1, 0, 1, "", "申報註記2"),
	TxntNo(1, 0, 16, "", "交易編號"),
	...
	validDate(1, 0, 8, "", "交易生效日(DDMMYYYY)"),
	remitCcy(1, 0, 3, "", "匯款幣別"),
	payCcy(1, 0, 3, "", "付款幣別"),
	...
	custTel(1, 0, 14, "", "客戶聯絡電話(付款人)"),
	custBirthday(2, 0, 8, "", "客戶生日(付款人)"),
	custKindCbMemo(1, 0, 2, "", "客戶身份別(付款人)"),
	idType(1, 0, 2, "", "證件類型(付款人)"),
	idNo(1, 0, 11, "", "證件號碼(付款人)"),
	rsdntIssueDate(2, 0, 8, "", "居留證核發日期(付款人) (DDMMYYYY)"),
	rsdntValidDate(2, 0, 8, "", "居留證有效期限(付款人) (DDMMYYYY)"),
	...
	Cactx502ResultN2NTxFileDefinition(int type, int required, int length, String columnName, String name) {
		this.type = type;
