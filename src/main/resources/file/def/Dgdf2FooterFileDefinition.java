 ...
 * @since
 */
public enum Dgdf2FooterFileDefinition implements IFileDefinition {
	...
	Dgdf2FooterFileDefinition(int type, int required, int length, String columnName, String name) {
		this.type = type;
